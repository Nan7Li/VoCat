...
> **Halo 1.1.13** 是基于 [VoCat](https://github.com/MengMengCode/VoCat) v0.2.23，并同步至上游提交 `6b41121` 的个人界面与发行版，原作者为 Vocat Project Authors。模组、IMS、WiFi Calling、eSIM 和代理等核心能力都是原项目的工作。本分支只改了界面、Halo 品牌、可自定义主色，以及少量本地修复。仍适用 [Vocat Research & Evaluation License](../LICENSE)。详见 [ATTRIBUTION.md](../ATTRIBUTION.md)。

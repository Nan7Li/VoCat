...
Halo 1.1.12 is a personal interface and release. It is **based on VoCat**.

- Upstream project: [MengMengCode/VoCat](https://github.com/MengMengCode/VoCat)
- Synced through: VoCat v0.2.23 (`03682ba`)
...
Everything else — modem control, IMS / WiFi Calling, SMS, eSIM, proxy, notifications — comes from VoCat. Halo 1.1.12 includes upstream changes through VoCat v0.2.23.

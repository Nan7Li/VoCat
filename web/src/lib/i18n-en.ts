...
export const EN_DICT: Record<string, string> = {
  ...
  "后台定期查询 Halo 发行版": "Periodically query the Halo release feed",
  自动安装并重启: "Install automatically and restart",
  发现新版本后下载校验并替换本机程序: "Download, verify, and replace this binary when a newer release is found",
  检查间隔: "Check interval",
  "每 1 小时": "Every hour",
  ...
  上次检查: "Last check",
  本机直连: "Direct from this host",
  "走 WG 隧道": "Send via WG tunnel",
  "让 Bot API 从指定隧道出去。隧道需已连接，且 AllowedIPs 包含 Telegram 或 0.0.0.0/0。不会改路由器默认路由。":
    "Send Bot API traffic out the selected tunnel. The tunnel must be up, and AllowedIPs must include Telegram or 0.0.0.0/0. This does not replace the router default route.",
  ...
  "官方 VoCat 有新内容:": "Official VoCat has new content:",
  "官方 VoCat 暂无更新于已同步版本之后": "No official VoCat updates after the synced version",
  "已合并进 Halo": "Mark as merged into Halo",
  "已记录为同步到该 VoCat 版本": "Recorded as synced to that VoCat version",
  "检查 VoCat 失败": "Failed to check official VoCat",
  记录同步版本失败: "Failed to record the synced version",
  自动更新设置已保存: "Automatic update settings saved",
  自动更新设置保存失败: "Failed to save automatic update settings",

  "WG 隧道": "WG Tunnels",
  "在本机用 wg-quick 管理 WireGuard 配置，可开机自动拉起":
    "Manage WireGuard configs on this host with wg-quick, including start-on-boot",
  添加隧道: "Add tunnel",
  "当前主机未安装 WireGuard。Linux 上安装 kmod-wireguard、wg 和 ip 后即可连接。":
    "WireGuard is not installed on this host. Install kmod-wireguard, wg, and ip on Linux to connect.",
  "正在加载隧道…": "Loading tunnels…",
  "还没有 WG 隧道": "No WireGuard tunnels yet",
  "粘贴一份标准 wg-quick 配置即可保存，之后可一键连接或开机自动启动。":
    "Paste a standard wg-quick config to save it, then connect it or start it on boot.",
  开机启动: "Start on boot",
  系统隧道: "Host tunnel",
  由路由器网络配置管理: "Managed by the router network config",
  断开: "Disconnect",
  连接: "Connect",
  "删除 WG 隧道": "Delete WG tunnel",
  "删除后配置会从本机移除。若隧道正在运行，会先断开。":
    "The config will be removed from this host. A running tunnel is brought down first.",
  隧道已保存: "Tunnel saved",
  隧道已添加: "Tunnel added",
  隧道已关闭: "Tunnel disconnected",
  隧道已连接: "Tunnel connected",
  隧道已删除: "Tunnel deleted",
  保存隧道失败: "Failed to save the tunnel",
  切换隧道失败: "Failed to toggle the tunnel",
  删除隧道失败: "Failed to delete the tunnel",
  请填写名称和配置: "Name and config are required",
  "修改 WG 隧道": "Edit WG tunnel",
  "添加 WG 隧道": "Add WG tunnel",
  网卡名: "Interface",
  "留空则自动分配 halo0、halo1…": "Leave blank to assign halo0, halo1, …",
  开机自动连接: "Connect on boot",
  "Halo 启动后会尝试 wg-quick up": "Halo will run wg-quick up after it starts",
  "使用标准 wg-quick 配置。私钥不会回显到页面；修改时保留 ******** 即可沿用原密钥。":
    "Use a standard wg-quick config. Private keys are not shown again; keep ******** when editing to reuse the stored key.",
  ...
  "Halo 最终用户许可与免责声明": "Halo End User License Agreement & Disclaimer",
  "基于 VoCat": "Based on VoCat",
  "基于 VoCat，原作者 Vocat Project Authors": "Based on VoCat by the Vocat Project Authors",
  "Halo 是基于 VoCat 的个人界面与发行版。模组、IMS、WiFi Calling 等核心能力来自原项目。": "Halo is a personal UI and release based on VoCat. The modem, IMS, and WiFi Calling stack comes from the original project.",
  "外观": "Appearance",
  "主色调": "Accent color",
  "主色可自定义，默认接近 Grok 的暖金色": "Customizable accent. Default is a soft apricot orange.",
  "主色可自定义，默认是柔和杏橙色": "Customizable accent. Default is a soft apricot orange.",
  "杏橙": "Apricot",
  "Grok 金": "Grok gold",
  "奶油": "Cream",
  "赤铜": "Copper",
  ...
  "浏览器软电话": "Browser softphone",
  "VoWiFi IMS、浏览器音频与来电通知": "VoWiFi IMS, browser audio, and incoming-call notifications",
  "浏览器音频已连接": "Browser audio connected",
  "正在连接浏览器音频…": "Connecting browser audio…",
  "浏览器音频不可用，请检查麦克风权限": "Browser audio unavailable; check microphone permission",
  "电话号码": "Phone number",
  "拨号": "Dial",
  "当前没有通话": "No calls",
  "未知号码": "Unknown number",
  "VoWiFi 来电": "Incoming VoWiFi call",
  "来电": "Incoming",
  "去电": "Outgoing",
  "接听": "Answer",
  "挂断": "Hang up",
  "当前射频模式": "Current radio mode",
  "4G 数据": "4G data",
  "切换中": "Switching",
  "下载脱敏诊断包": "Download redacted diagnostics",
  "VoWiFi、飞行模式与漫游数据相互独立，切换失败不会连带关闭其它项": "VoWiFi, airplane mode, and roaming data are independent; a failed toggle does not turn the others off",
  "启用时进入 VoWiFi；关闭不影响飞行模式或漫游数据": "Enables VoWiFi. Turning it off does not change airplane mode or roaming data",
  "可独立开关蜂窝射频，不因 VoWiFi 而禁用": "Cellular RF can be switched independently and is not disabled by VoWiFi",
  "IMS 未就绪": "IMS not ready",
  "软电话暂不可用": "Softphone unavailable",
  "有来电，点击接听开始通话": "Incoming call — press Answer to start talking",
  "电话": "Phone",
  "通话记录": "Call history",
  "暂无通话记录": "No call history yet",
  "接通": "Answered",
  "未接": "Missed",
  "进行中": "In progress",
  "已结束": "Ended",
  "蜂窝": "Cellular",
  "通话设备": "Calling device",
  "ePDG 健康检查": "ePDG health check",
  "可达": "Reachable",
  "不可达": "Unreachable",
  "通过": "Pass",
  "检查时间": "Checked at",
  "ePDG 主机": "ePDG host",
  "飞行模式·锁定": "Airplane · locked",
  "4G": "4G",
  "VoWiFi": "VoWiFi",
  "诊断包": "Diagnostics",
  "飞行模式已开启": "Airplane mode enabled",
  "飞行模式已关闭": "Airplane mode disabled",
  "VoWiFi 已关闭": "VoWiFi disabled",
  "VoWiFi 已开启，等待 IMS 注册…": "VoWiFi enabled; waiting for IMS registration…",
  "ePDG 探测失败，VoWiFi 已被自动关闭": "ePDG probe failed — VoWiFi was disabled automatically",
  "ePDG 健康检查失败，VoWiFi 已被自动关闭": "ePDG health check failed — VoWiFi was disabled automatically",
  "VoWiFi 未开启：请先在设备页打开「VoWiFi」开关，等待 IMS 注册完成。": "VoWiFi is off — enable VoWiFi on the device page and wait for IMS registration",
  "VoWiFi 需要射频关闭，飞行模式由系统锁定；关闭 VoWiFi 后可手动切换。": "VoWiFi needs the radio off; airplane mode is locked by the system. Disable VoWiFi to toggle it manually",
  "飞行模式开关（独立于 VoWiFi，不会联动）": "Airplane mode toggle (independent of VoWiFi, no coupling)",
  "VoWiFi 开关（独立于飞行模式）": "VoWiFi toggle (independent of airplane mode)",
  "蜂窝数据开关（漫游数据，仅供受保护路由使用）": "Cellular data toggle (roaming data for protected routes only)",
  "开启飞行模式失败": "Failed to enable airplane mode",
  "关闭飞行模式失败": "Failed to disable airplane mode",
  "开启 VoWiFi 失败": "Failed to enable VoWiFi",
  "关闭 VoWiFi 失败": "Failed to disable VoWiFi",
  "尚无 ePDG 探测记录（启动 VoWiFi 时自动检测 UDP/500 与 UDP/4500）。": "No ePDG probe yet (UDP/500 and UDP/4500 are checked when VoWiFi starts)",
  "UDP/500 或 UDP/4500 未响应。请检查代理出口与 ePDG 域名解析后重新开启 VoWiFi。": "UDP/500 or UDP/4500 did not respond. Check the proxy egress and ePDG DNS, then re-enable VoWiFi",
  "最近一次探测未通过": "Last probe did not pass",
  "ePDG 端口不可达，VoWiFi 可能无法注册。": "ePDG ports unreachable — VoWiFi may fail to register",
  "暂无设备，请先在「设备管理」中添加设备。": "No devices yet — add one under Devices first",
  "刷新中…": "Refreshing…",
  "号码 · 方向 · 时间 · 时长 · 接通/未接/失败 · 设备": "Number · direction · time · duration · answered/missed/failed · device",
  "当前阶段": "Current phase",
  "原因": "Reason",
  "IMS 注册未完成": "IMS registration incomplete",
  "IMS 尚未注册，请等待注册完成或点击「重连 VoWiFi」。": "IMS is not registered yet — wait for registration or press Reconnect VoWiFi",
  "IMS 尚未注册，请先在设备页开启 VoWiFi 并等待注册完成。": "IMS is not registered yet — enable VoWiFi on the device page and wait",
  "拨号盘": "Keypad",
  "收起拨号盘": "Hide keypad",
  "退格": "Backspace",
  "长按输入 +": "Long-press for +",
  "长按或右键清空": "Long-press or right-click to clear",
  "回拨": "Redial",
  "填入拨号盘": "Fill keypad",
  "芯片详情": "Chip details",
  "收起芯片详情": "Hide chip details",
  "刚刚释放约 {s}": "Freed about {s}",
  "刚刚占用约 {s}": "Used about {s}",
  "飞行·锁": "Air · lock",
  "拨号中": "Calling…",
  "正在接通": "Connecting…",
  "已接通": "Connected",
  "正在呼叫对方，请稍候": "Calling the other party, please wait",
